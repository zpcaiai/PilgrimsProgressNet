...
EXPECTED = {
    ...
    "celestial_city": [
        ...
        "ENV_Celestial_GatePlatform", "ENV_Celestial_InteriorFloor",
        ...
        "PROP_Celestial_Throne", "PROP_Celestial_Lord_Glow", "PROP_TreeOfLife",
        "ENV_RiverOfLife_WaterSurface", "PROP_FeastTable_01",
        "NPC_Hopeful", "NPC_ShiningOne_01", "NPC_ShiningOne_02", "NPC_Gatekeeper",
        "TRIGGER_EnterCelestialCity", "TRIGGER_FeastWelcome", "TRIGGER_ThroneWorship",
